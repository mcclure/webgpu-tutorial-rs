...
pub fn make_texture_gray(
    ...
    if source {
        usage = usage | wgpu::TextureUsages::TEXTURE_BINDING.union(wgpu::TextureUsages::COPY_SRC)
    };
...
pub fn make_texture_bind_group_layout(
    device: &wgpu::Device,
    additional: &[wgpu::BindGroupLayoutEntry],
    label_tag: &str,
    ...
    device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
        label: Some(&format!("{} texture bind group layout", label_tag)),
...
pub fn make_pipeline(
    ...
    let pipeline_layout = device.create_pipeline_layout(&wgpu::PipelineLayoutDescriptor {
        label: Some(&format!("{} pipeline layout", label_tag)),
        bind_group_layouts: bind_groups,
        push_constant_ranges: &[],
    });

    let render_pipeline = device.create_render_pipeline(&wgpu::RenderPipelineDescriptor {
        label: Some(&format!("{} pipeline", label_tag)),
